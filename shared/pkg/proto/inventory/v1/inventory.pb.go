...
// Информация о детали для сборки космических кораблей
type Part struct {
...
// Гибкие метаданные для дополнительного описания детали
type MetadataValue struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Types that are valid to be assigned to Kind:
	//
	//	*MetadataValue_StringValue
	//	*MetadataValue_Int_64Value
...
func (x *MetadataValue) GetInt_64Value() int64 {
	if x != nil {
		if x, ok := x.Kind.(*MetadataValue_Int_64Value); ok {
			return x.Int_64Value
		}
	}
	return 0
}
...
func (x *MetadataValue) GetBoolValue() *wrapperspb.BoolValue {
	if x != nil {
...
type MetadataValue_Int_64Value struct {
	Int_64Value int64 `protobuf:"varint,2,opt,name=int_64_value,json=int64Value,proto3,oneof"`
}
...
// Запрос на получение определенной детали
...
// Ответ на запрос получения определенной детали
...
type ListPartsRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Filter        *PartsFilter           `protobuf:"bytes,1,opt,name=filter,proto3,oneof" json:"filter,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
// Список деталей, удовлетворяющий фильтрам в запросе (если имеются, если нет - выдаст полный список)
...
const file_inventory_v1_inventory_proto_rawDesc = "" +
	"\n" +
	"\x1cinventory/v1/inventory.proto\x12\finventory.v1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/wrappers.proto\"\xdd\x04\n" +
	"\x04Part\x12\x12\n" +
	...
	"\x05value\x18\x02 \x01(\v2\x1b.inventory.v1.MetadataValueR\x05value:\x028\x01\"j\n" +
	"\n" +
	"Dimensions\x12\x16\n" +
	...
	"\awebsite\x18\x03 \x01(\tR\awebsite\"\xc2\x01\n" +
	"\rMetadataValue\x12#\n" +
	"\fstring_value\x18\x01 \x01(\tH\x00R\vstringValue\x12\"\n" +
	"\fint_64_value\x18\x02 \x01(\x03H\x00R\n" +
	"int64Value\x12#\n" +
	"\fdouble_value\x18\x03 \x01(\x01H\x00R\vdoubleValue\x12;\n" +
	"\n" +
	"bool_value\x18\x04 \x01(\v2\x1a.google.protobuf.BoolValueH\x00R\tboolValueB\x06\n" +
	"\x04kind\"\xbc\x01\n" +
	...
	"\x04part\x18\x01 \x01(\v2\x12.inventory.v1.PartR\x04part\"U\n" +
	...
	"\tListParts\x12\x1e.inventory.v1.ListPartsRequest\x1a\x1f.inventory.v1.ListPartsResponseBSZQgithub.com/delyke/go_workspace_example/shared/pkg/proto/inventory/v1;inventory_v1b\x06proto3"
...
var file_inventory_v1_inventory_proto_depIdxs = []int32{
	...
	12, // 6: inventory.v1.MetadataValue.bool_value:type_name -> google.protobuf.BoolValue
	0,  // 7: inventory.v1.PartsFilter.categories:type_name -> inventory.v1.Category
	1,  // 8: inventory.v1.GetPartResponse.part:type_name -> inventory.v1.Part
	5,  // 9: inventory.v1.ListPartsRequest.filter:type_name -> inventory.v1.PartsFilter
	1,  // 10: inventory.v1.ListPartsResponse.parts:type_name -> inventory.v1.Part
	4,  // 11: inventory.v1.Part.MetadataEntry.value:type_name -> inventory.v1.MetadataValue
	6,  // 12: inventory.v1.InventoryService.GetPart:input_type -> inventory.v1.GetPartRequest
	8,  // 13: inventory.v1.InventoryService.ListParts:input_type -> inventory.v1.ListPartsRequest
	7,  // 14: inventory.v1.InventoryService.GetPart:output_type -> inventory.v1.GetPartResponse
	9,  // 15: inventory.v1.InventoryService.ListParts:output_type -> inventory.v1.ListPartsResponse
